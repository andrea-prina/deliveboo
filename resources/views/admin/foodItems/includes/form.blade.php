...
<div class="form-outline mb-4">
    ...
    <input type="text" required max='255'id="name" class="form-control" name="name" required value="{{ old('name', $food->name) }}"/>
</div>

<div class="form-outline mb-4">
    <label class="form-label" for="description">Description <span class="star">*</span></label>
    <input type="text" required id="description" class="form-control" name="description" required value="{{ old('description', $food->description) }}" />
</div>
